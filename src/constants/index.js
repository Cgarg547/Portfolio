...
export const projects = [
    {
        name: "DevReview AI",
        description:
        "AI-powered code review platform that analyzes GitHub repository files and provides structured, actionable feedback on bugs, security, performance, maintainability, and code quality.",
        link: "https://github.com/Cgarg547/DevReview-AI",
        liveLink: "https://dev-review-ai-ruddy.vercel.app/dashboard",
        iconUrl: devreview,
        theme: "btn-back-blue",
    },
    {
        name: "Finora",
        description:
        "AI-powered personal finance platform for tracking transactions, managing budgets, analyzing spending, and generating personalized financial insights.",
        link: "https://github.com/Cgarg547/finora-personal-finance",
        liveLink: "https://finora-personal-finance-kappa.vercel.app/",
        iconUrl: finora,
    ...
    },
    {
        name: "TaskForge",
        description:
        "Multi-tenant B2B task management SaaS with organization-based authentication, role-based permissions, Kanban workflows, subscription tiers, and a FastAPI backend.",
        link: "https://github.com/Cgarg547/TaskForge",
        liveLink: "https://task-forge-eight-blue.vercel.app",
        iconUrl: taskforge,
